namespace LOCAM
{
    ...
    public class CardUI {
        ...
        public CardUI move(int x, int y, Card base, CreatureOnBoard card, bool isOnBoard) {
            setVisible(true);
        ...
        public CardUI setVisible(bool visible) {
        ...
        public CardUI setExtrasVisibility(bool visible) {
